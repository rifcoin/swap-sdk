...
import { BigintIsh, Currency, CurrencyAmount, Percent, TradeType, validateAndParseAddress } from '@rifcoin/sdk-core'
...
import { abi } from '@rifcoin/toolkit/artifacts/contracts/SwapRouter.sol/SwapRouter.json'
